...
export function LobbyScreen() {
    const { currentUser, rooms, login, createRoom, joinRoom, leaveRoom, requestSync } = useLobbyStore();
                    ...
                    {isCreating && (
                        ...
                        >
                            <Card className="p-6 bg-primary/5 border-primary/20">
                                <form
                                    onSubmit={(e) => { e.preventDefault(); if (newRoomName) { createRoom(newRoomName); setIsCreating(false); } }}
