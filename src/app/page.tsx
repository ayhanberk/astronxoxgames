...
import { Monitor, Box, RotateCcw, Sun, Moon, Zap, Sparkles, Snowflake, Umbrella, Rocket, Cpu, Candy } from 'lucide-react';
...
export default function Home() {
  ...
  // 2. Logged In, No Room -> Show Lobby Dashboard
  if (!currentRoomId) {
    return <LobbyScreen />;
  }
  ...
  // Loading State: Room ID set but room data not synced yet
  if (currentRoomId && !currentRoom) {
    return (
      <div className="flex h-screen w-full items-center justify-center bg-background">
        <div className="flex flex-col items-center gap-4">
          <div className="h-12 w-12 animate-spin rounded-full border-4 border-primary border-t-transparent" />
          <p className="text-lg font-bold animate-pulse">Connecting to Arena...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <>
      <main className="relative container mx-auto min-h-screen px-4 py-8 flex flex-col items-center justify-center z-10 pointer-events-none">
        ...
        <div className="contents [&>*]:pointer-events-auto relative z-50">
          ...
          <div className="flex flex-col items-center gap-4 mb-8 z-[90] relative pointer-events-auto">
            <motion.div
          ...
          <motion.div
            ...
            className="mt-auto pt-6 flex flex-col items-center gap-2 w-full z-50 relative pointer-events-auto"
          >
            {currentUser?.id !== currentRoom?.hostId && (
